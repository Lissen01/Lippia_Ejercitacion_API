...
public class CatSteps extends PageSteps {
    ...
    public void realizoUnaPeticionOperationAEntityAlEndpointDeAnalisisRequest(
    ...
    @When("realizo una peticion '(.*)' a '(.*)' al endpoint de razas - '(.*)'$")
    public void realizoUnaPeticionOperationAEntityAlEndpointDeRazasRequest(String operation, String entity, String request) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        EntityConfiguration.valueOf(entity).getEntityService().getMethod(operation.toLowerCase(), String.class).invoke("", request);
    }

    @When("realizo una peticion '(.*)' a '(.*)' al endpoint de imageId - '(.*)'$")
    public void realizoUnaPeticionOperationAEntityAlEndpointDeImageIdRequest(String operation, String entity, String request) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        EntityConfiguration.valueOf(entity).getEntityService().getMethod(operation.toLowerCase(), String.class).invoke("", request);
    }

    @When("realizo una peticion '(.*)' a '(.*)' al endpoint de id - '(.*)'$")
    public void realizoUnaPeticionOperationAEntityAlEndpointDeIdRequest(String operation, String entity, String request) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        EntityConfiguration.valueOf(entity).getEntityService().getMethod(operation.toLowerCase(), String.class).invoke("", request);
    }
}
